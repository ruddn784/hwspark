...
#from airflow.airflow import SendEmailOperator
...
with DAG(dag_id=str(DAG_CONFIG['dag_id']),
    ...
    check_csv_report_exist = GCSObjectExistenceSensor(
        task_id='sniffer',
        bucket=ST_BUCKET_ID,
        object='report_'+CURR_DATE+'.csv',
        #object=f'gs://{ST_BUCKET_ID}/report_{CURR_DATE}.csv',
   ...
   # start_pipeline >> save_csv_report_to_gcs >> send_email >> finish_pipeline
    #start_pipeline >>  check_csv_report_exist >> send_email >> finish_pipeline
